...
| Cached source preservation on native push | Supported | The destination response is not committed into the source runtime |
| Exact-entry prepared document handoff | Supported | Opt-in adapter capability; invalid or missing handoff safely refetches |
...
| Page snapshots, page prefetch, scroll/focus restoration | Not supported | Prepared navigation response handoff is supported; speculative page prefetch remains host-owned |
